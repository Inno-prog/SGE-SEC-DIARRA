...
class _SanctionTile extends ConsumerWidget {
  ...
  Color get _color {
    switch (sanction.type) {
      case AppConstants.sanctionWarning:
        return AppColors.warning;
      case AppConstants.sanctionBlame:
        return AppColors.accent;
      case AppConstants.sanctionSuspension:
        return AppColors.error;
      case AppConstants.sanctionLayoff:
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Column(
          ...
          children: [
            Text(
              DateFormat('dd/MM/yyyy').format(sanction.date),
              style: const TextStyle(fontSize: 12),
            ),
            if (sanction.dureeSuspension != null)
              Text(
                '${sanction.dureeSuspension}j',
        ...
        onLongPress: () async {
          final ok = await showConfirm(
            context,
            title: 'Supprimer',
            message: 'Supprimer cette sanction ?',
          );
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        showSnack(context, 'Sanction enregistrée');
      }
    } catch (e) {
                ...
                itemBuilder: (_, i) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        '${t.employeeNom} • ${t.organisme} • ${t.dureeJours}j',
                      ),
                      trailing: Column(
                        mainAxisSize: MainAxisSize.min,
                        mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      onLongPress: () async {
                        ...
                        if (ok && context.mounted) {
                          await ref
                              ...
                              .deleteTraining(t.id);
                          if (context.mounted)
                            showSnack(context, 'Formation supprimée');
                        }
                      },
                    ),
                  );
...
class _TrainingFormState extends ConsumerState<_TrainingForm> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (mounted) {
        Navigator.pop(context);
        showSnack(context, 'Formation enregistrée');
      }
    } catch (e) {
      if (mounted) showSnack(context, 'Erreur: $e', isError: true);
    } finally {
                ...
                itemBuilder: (_, i) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        'Année ${e.annee} • Par ${e.evaluateurNom}',
                      ),
                      trailing: Column(
                        mainAxisSize: MainAxisSize.min,
                        mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      onLongPress: () async {
                        ...
                        if (ok && context.mounted) {
                          ...
                          if (context.mounted)
                            showSnack(context, 'Évaluation supprimée');
                        }
                      },
                    ),
                  );
...
class _EvaluationFormState extends ConsumerState<_EvaluationForm> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (mounted) {
        Navigator.pop(context);
        showSnack(context, 'Évaluation enregistrée');
      }
    } catch (e) {
      if (mounted) showSnack(context, 'Erreur: $e', isError: true);
    } finally {
